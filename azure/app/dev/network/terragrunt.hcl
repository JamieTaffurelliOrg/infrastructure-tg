terraform {
  source = "git::https://github.com/JamieTaffurelliOrg/az-spokevirtualnetwork-tf///?ref=0.0.6"
}
...
inputs = {
  ...
  peerings = [
    {
      remote_vnet_name                = "vnet-conn-dev-net-weu1-001"
      remote_vnet_resource_group_name = "rg-conn-dev-net-weu1-001"
    }
  ]
  private_dns_zones = [
    {
