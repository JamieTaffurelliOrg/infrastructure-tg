terraform {
  source = "git::https://github.com/JamieTaffurelliOrg/az-virtualwan-tf///?ref=0.0.5"
}
...
inputs = {
  ...
  resource_group_name = "rg-${local.lz_environment_hyphen}-vwan-${local.location_short}-001"
