...
inputs = {
  ...
  resource_group_name = "rg-conn-dev-afwp-wus2-001"
  location            = "westus2"
  ip_groups = [
    {
      name        = "ipgrp-conn-dev-afwp-wus2-001"
      cidr_ranges = ["10.128.0.0/16"]
    }
  ]
  base_policy_name = "afwp-conn-dev-afwp-wus2-001"
  base_policy_sku  = "Standard"
  base_policy_rule_collection_groups = [
    {
      name     = "afwp-conn-dev-afwp-wus2-001"
      priority = 800
