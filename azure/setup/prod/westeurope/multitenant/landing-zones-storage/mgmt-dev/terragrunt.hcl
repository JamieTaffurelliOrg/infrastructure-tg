...
locals {
  tags                  = merge(include.azure.locals.default_tags, include.landing_zone.locals.default_tags, include.environment.locals.default_tags, { environment = "dev", stack = "management" })
  org_prefix            = include.azure.locals.org_prefix
  lz_environment_hyphen = "mgmt-dev"
  lz_environment_concat = "mgmtdev"
...
inputs = {
  ...
  log_analytics_workspace = {
    name                = "log-mgmt-dev-log-${local.location_short}-001"
    resource_group_name = "rg-mgmt-dev-log-${local.location_short}-001"
  }
