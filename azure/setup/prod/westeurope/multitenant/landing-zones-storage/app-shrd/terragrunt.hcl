...
locals {
  tags                  = merge(include.azure.locals.default_tags, include.landing_zone.locals.default_tags, include.environment.locals.default_tags, { environment = "shared", stack = "app" })
  org_prefix            = include.azure.locals.org_prefix
  lz_environment_hyphen = "app-shrd"
  lz_environment_concat = "appshrd"
